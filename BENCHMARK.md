...
| `large_web_128x128.png` (128×128 RGBA web graphic) | 41,604 | 1,946 (95.3%) | **694** (98.3%) | 693 (98.3%) |

### Photographic Images

| Image | Original | fpng | optipng | pngcrush |
|-------|----------|------|---------|----------|
| `large_photo_256x256.png` (256×256 RGBA) | 94,669 | 22,001 (76.8%) | **12,598** (86.7%) | 12,598 (86.7%) |
